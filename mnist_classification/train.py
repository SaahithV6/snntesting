...
def train(num_epochs=10, batch_size=128, lr=0.001, beta=0.95, 
          num_steps=25, save_dir='checkpoints', seed=42):
    ...
    model = MNISTNet(beta=beta, num_steps=num_steps).to(device)
